...
public class GamePiece {
    ...
    private int xPos; // the x position of a game piece
    private int yPos; // the y position of a game piece
    private boolean claimed; // when a piece is already selected by the other player

    // method to initialize game piece
    ...
    // method to get the x position of the game piece
    public int getxPos() {
        return xPos;
    }

    // method to get the y position of the game piece
    public int getyPos() {
        return yPos;
    }

    // method to know if game piece is already selected by the other player
    public boolean isClaimed() {
        return claimed;
    }

    // method to set the piece that is already selected by the other player
